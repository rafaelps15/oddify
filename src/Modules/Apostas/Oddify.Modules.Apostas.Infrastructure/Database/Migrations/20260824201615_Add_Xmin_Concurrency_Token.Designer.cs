...
namespace Oddify.Modules.Apostas.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260824201615_Add_Xmin_Concurrency_Token")]
    partial class Add_Xmin_Concurrency_Token
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Oddify.Common.Infrastructure.Processing.InternalCommand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTime>("EnqueuedOnUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("enqueued_on_utc");
                    ...
                    b.HasIndex("EnqueuedOnUtc", "ProcessedOnUtc")
                        .HasDatabaseName("idx_internal_commands_unprocessed")
                        .HasFilter("processed_on_utc IS NULL");

                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("EnqueuedOnUtc", "ProcessedOnUtc"), new[] { "Id", "Type", "Content" });

                    b.ToTable("internal_commands", "apostas");
                });
